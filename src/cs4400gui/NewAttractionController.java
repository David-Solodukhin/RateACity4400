...
public class NewAttractionController implements Initializable {
    ...
    @FXML protected void submitAttraction(ActionEvent event) {
        ...
        try {
            if (Integer.parseInt(rating.getText()) <= 0 || Integer.parseInt(rating.getText()) > 5 || comment.getText().equals("")) {
                Alert wrong_rating = new Alert(Alert.AlertType.ERROR, "Provide a valid comment and rating!");
            ...
            */
            ...
            e.printStackTrace();
            Alert wrong_rating = new Alert(Alert.AlertType.ERROR, "Your data was incorrect");
            wrong_rating.showAndWait();
        }
    }
